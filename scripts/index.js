...
function handleUserInteraction() {
  playMusic();
  document.removeEventListener('click', handleUserInteraction); // Hapus listener setelah musik diputar
}

document.addEventListener('click', handleUserInteraction); // Tambahkan listener untuk mendeteksi klik di mana saja
...
x = setInterval(function () {
  ...
  function anim() {
    ...
    if (!done) {
      window.requestAnimationFrame(anim); // Lanjutkan animasi jika belum selesai
    } else {
